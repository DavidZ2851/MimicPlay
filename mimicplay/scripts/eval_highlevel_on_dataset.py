...
def eval_highlevel_on_dataset(args):
    ...
    # Scale intrinsic for cropped/resized image
    ...
    with h5py.File(args.dataset, 'r') as f:
        ...
        for demo_idx, demo_name in enumerate(demos):
            ...
            intrinsic_scaled[0, 0] = intrinsic[0, 0] * scale
            intrinsic_scaled[1, 1] = intrinsic[1, 1] * scale
            intrinsic_scaled[0, 2] = (intrinsic[0, 2] - crop_x1) * scale
            intrinsic_scaled[1, 2] = (intrinsic[1, 2] - crop_y1) * scale
            ...
            for t in tqdm(range(0, T, args.skip_frames), desc=demo_name):
                ...
                if video_writer is not None:
                    ...
                    gt_2d, gt_valid = project_to_image(gt_cam, intrinsic_scaled, image_size)
                    ...
                    pred_2d, pred_valid = project_to_image(pred_cam, intrinsic_scaled, image_size)
